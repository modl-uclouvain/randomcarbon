...
from randomcarbon.output.taggers import BasicTag, EnergyTag, SymmetryTag
...
runner = BranchingRunner(calculator_factory=calculator, evolvers=evolvers,
                         initial_structure=initial_structure, blockers=blockers, filters=filters,
                         fmax=0.05, steps=1000, constraints=constraints,
                         optimizer="BFGS", store=store, taggers=taggers, spacegroup_primitive=227)

runner.run(max_structures=30)
